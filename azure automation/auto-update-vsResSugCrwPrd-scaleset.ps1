...
$vsSuggestSleepName = "vsResSugSlpPrd"
#$vsSuggestCrewName = "vsResSugCrwPrd"
#$vsTextSleepName = "vsTxtExtSlpPrd"
#$vsTextCrewName = "vsTxtExtCrwPrd"
...
$vmssName="vsResSugCrwPrd"
$queueName="CrewInvoiceXMLProduction"
$skuCapacity=0
